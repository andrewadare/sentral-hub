...
// for how to calibrate the sensors.
// This sketch duplicates a lot of code found in the SENtral class. At some point it should be refactored.
...
/* EM7180_MPU9250_BMP280_t3 Basic Example Code
 ...
 in this case the MPU9250 (with embedded MPU9250 + AK8963C), and does sensor fusion with quaternions as its output.
 The SENtral loads firmware from the
